...
const PLAYER_FISH_FRENZY_DURATION = 2.5
...
const FISH_TO_TRIGGER_FISH_FRENZY = 5

# Items
#const ITEM_SPAWN_MINIMUM_SECONDS = 5;
#const ITEM_SPAWN_MAXIMUM_SECONDS = 10;
const ITEM_SPAWN_MINIMUM_SECONDS = 2
const ITEM_SPAWN_MAXIMUM_SECONDS = 4

const HEALTH_POTION_BONUS = 20;
const POWER_UP_ACTIVE_DURATION = 10;
const MINI_SHARK_ACTIVE_DURATION = 30;
